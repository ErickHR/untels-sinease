                    ...
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-12 col-sm-3">
                                <h3 class="title-form">Lista de Personas</h3>
                            </div> 
                        ...
                        <table class="table align-items-center table-flush table-hover">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" data-sort="budget" class="sort">CARGO</th> 
                                    <th scope="col"></th>
                                    <th scope="col"></th>
                                </tr>
                            </thead> 
                            <tbody>
                                <tr class="list" v-for="( data, index ) in dataList" :key=" index" >
                                    ...
                                    <td class="text-muted">
                                        <b>{{ data.position ? data.position.name : '' }}</b>
                                    </td>
                                    <!-- <td class="text-muted">
                                        <b>
    ...
    methods: {
        ...
        async activeOrDesactiveItem( id, status ){
            ...
            try {
                ...
                const response = await axios.post( `person-active-desactive`, body )
        ...
        async getApiList( searchName ){
            try {
                ...
                const response = await searchName ? await axios.post( 'person-search', body  ) : await axios( 'person' )
