                    ...
                    <div class="card-body">
                        ...
                        <div class="origen-section ">
                            <div class="row pr-3">
                                ...
                                <div class="col-12 col-sm-12 col-xl-12 mt-3">
                                    <div class="form-row">
                                        ...
                                        <span class="input-widht col-12">
                                            <multiselect-component route="standar-by-office" @selectOption="selectOption"></multiselect-component>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-xl-12 mt-3">
                                    <div class="form-row">
                                        <label class="form-control-label col-12">CARPETA</label> 
                                        <span class="input-widht col-12">
                                            <multiselect-component route="directory-mine" @selectOption="selectOptionDirectory"></multiselect-component>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-xl-12 " v-if="action != 'search'">
                                    <div class="form-row">
                                        <label class="form-control-label col-12">DESCRIPCIÓN</label> 
                                        <span class="input-widht col-12">
                                            <input type="text" :placeholder="'Coloque la descripción para '+ nameButton.toLowerCase() " class="form-control text-primary col-12" v-model="dataForm.description"> 
                                        </span>
                                    </div>
                                </div>
