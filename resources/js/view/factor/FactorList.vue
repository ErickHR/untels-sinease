                    ...
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-12 col-sm-3">
                                <h3 class="title-form">Lista de Factores</h3>
                            </div> 
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush table-hover">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" data-sort="name" class="sort">DIMENSIÓN</th> 
                                    <th scope="col" data-sort="name" class="sort">FACTORES</th> 
                                ...
                                <tr class="list" v-for="( data, index ) in dataList" :key=" index" >
                                    ...
                                    <td class="text-muted">
                                        <div class="form-row mx-3" >
                                            <ul class="col-12" v-for="( factor, index ) in data.factor" :key="index+'factor'">
                                                <li class="">{{ factor.name }}</li>
                                            </ul>
                                        </div>
                                    </td>
                                    <td class="text-muted">
    ...
    methods: {
        ...
        async activeOrDesactiveItem( id, status ){
            ...
            try {
                ...
                const response = await axios.post( `factor-active-desactive`, body )
        ...
        async getApiList( searchName ){
            try {
                ...
                const response = await searchName ? await axios.post( 'factor-search', body  ) : await axios( 'dimension-with-factor' )
