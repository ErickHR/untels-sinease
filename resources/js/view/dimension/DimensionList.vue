                    ...
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-12 col-sm-3">
                                <h3 class="title-form">Lista de Dimensiones</h3>
                            </div> 
    ...
    methods: {
        ...
        async activeOrDesactiveItem( id, status ){
            ...
            try {
                ...
                const response = await axios.post( `dimension-active-desactive`, body )
        ...
        async getApiList( searchName ){
            try {
                ...
                const response = await searchName ? await axios.post( 'dimension-search', body  ) : await axios( 'dimension' )
