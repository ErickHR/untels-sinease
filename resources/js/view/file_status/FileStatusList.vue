                        ...
                        <table class="table align-items-center table-flush table-hover">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" data-sort="name" class="sort">COLOR</th> 
                                    <th scope="col" data-sort="name" class="sort">DESCRIPCIÓN</th> 
                                ...
                                <tr class="list" v-for="( data, index ) in dataList" :key=" index" >
                                    ...
                                    <td class="text-muted">
                                        <div style="width: 20px;
                                                height: 20px;
                                                border-radius: 100%;" :style="'background:'+data.color">
                                        </div>
                                    </td>
                                    <td class="text-muted">
                                        {{ data.need_msg ? 'SÍ' :  'NO' }}
    ...
    methods: {
        ...
        async activeOrDesactiveItem( id, status ){
            ...
            try {
                ...
                const response = await axios.post( `status-file-active-desactive`, body )
        ...
        async getApiList( searchName ){
            try {
                ...
                const response = await searchName ? await axios.post( 'status-file-search', body  ) : await axios( 'status-file' )
