                    ...
                    <div class="card-body">
                        ...
                        <div class="origen-section ">
                            <div class="row pr-3">
                                ...
                                <div class="col-12 col-sm-12 col-xl-12 ">
                                    <div class="form-row">
                                        <label class="form-control-label col-12">URL</label> 
                                        <span class="input-widht col-12">
                                            <input type="text" :placeholder="'Coloque el nombre para '+ nameButton.toLowerCase() " class="form-control text-primary col-12" v-model="dataForm.url"> 
                                            <span class="is-invalid-numero text-red"></span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-xl-12" v-if=" action != 'search' ">
                                    <div class="form-row">
                                        ...
                                        <span class="input-widht col-12">
                                            <input type="text" :placeholder="'Coloque el nombre icono para '+ nameButton.toLowerCase() " class="form-control text-primary col-12" v-model="dataForm.icon"> 
                                            <span class="is-invalid-numero text-red"></span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-xl-12 mt-3">
                                    <div class="form-row">
                                        <label class="form-control-label col-12">MODULO</label> 
                                        <span class="input-widht col-12">
                                            <multiselect-component route="module-get-active" 
    ...
    methods: {
            ...
            try {
                ...
                if( response.status == 200 ) {
                    ...
                    if( response.data.value ) {
                        ...
                        this.dataForm.module_id = response.data.data.module_id
        ...
        async apiForm(){
            ...
            try {
                ...
                let response = await this.axiosForm( 'permissions', '' )
